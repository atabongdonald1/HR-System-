  ...
  return (
    <div id="workforce-view" className="space-y-8">
      ...
      <div id="workforce-filters" className="flex gap-4 items-center bg-white p-4 rounded-2xl border border-slate-100 shadow-sm">
        ...
        <button id="btn-workforce-filter" className="flex items-center gap-2 px-4 py-2 bg-slate-50 text-slate-600 rounded-xl text-sm font-medium hover:bg-slate-100 transition-colors">
